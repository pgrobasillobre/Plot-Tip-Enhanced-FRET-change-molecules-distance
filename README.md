...
Simulated fluorescence intensities for the donor and acceptor molecules are plotted against the intermetallic distance of the phthalocyanines and compared to experimental data. **Simulated fluorescence intensities are normalized with respect to the maximum intensity within the experimental setup obtained for the acceptor**.
